...
pub struct PostgresView {
    ...
    generator_window: GeneratorWindow<PgRow, Postgres, PgType>,
    insertion_window: InsertionWindow<PgRow, Postgres, PgType>,
}
...
impl PostgresView {
    ...
    fn statement_filter(&self, row_idx: usize) -> Vec<String> {
        let sql_presenter = SqlPresenter::<Postgres>::default();
